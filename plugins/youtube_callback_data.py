    ...
    if cb_data.startswith("ytdata||"):
        ...
        if media_type == 'audio':
            buttons = InlineKeyboardMarkup([[InlineKeyboardButton(
                "ᴀᴜᴅɪᴏ", callback_data=f"{media_type}||{format_id}||{yturl}"), InlineKeyboardButton("ᴅᴏᴄᴜᴍᴇɴᴛ",
                                                                                                    callback_data=f"docaudio||{format_id}||{yturl}")]])
        else:
            buttons = InlineKeyboardMarkup([[InlineKeyboardButton(
                "ᴠɪᴅᴇᴏ", callback_data=f"{media_type}||{format_id}||{yturl}"), InlineKeyboardButton("ᴅᴏᴄᴜᴍᴇɴᴛ",
